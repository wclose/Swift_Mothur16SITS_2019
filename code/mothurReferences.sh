...
echo PROGRESS: Preparing SILVA database v1-9 sequence alignment files. 
...
# Using mothur to only keep sequences from the v1-9 region of the 16S rRNA DNA region
mothur "#pcr.seqs(fasta="${OUTDIR}"/silva.seed.align, start=1046, end=43116, keepdots=F, processors=8)"

# Renaming the final v1-9 SILVA reference file
mv "${OUTDIR}"/silva.seed.pcr.align "${OUTDIR}"/silva.v19.align
